...
2.	[Understanding Machine Learning] (http://www.cs.huji.ac.il/~shais/UnderstandingMachineLearning/index.html) by Shai Shalev-Shwartz and Shai Ben-David.
...
**Note:** Once you have the basics in place, it would be a great idea to practice some problems on Kaggle. [Kaggle](https://www.kaggle.com/) is a well-known Machine Learning contest platform where you can compete with others in training ML models on various datasets.
Please do take up ML projects. This is the most important point. Ideally, you’d want to have not only ML experience but also some great projects on your resume that you can showcase. These projects will help you distinguish yourself from other candidates. Machine Learning is as much of an art as it is a science. You will learn it from experience. Your focus should be on attempting multiple ML projects so as to gain experience and build a strong profile.
